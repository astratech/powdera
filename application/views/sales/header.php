    ...
    <body>
        ...
        <div id="ui" class="ui">
            ...
            <aside id="aside" class="ui-aside" style="background-color: #fafafa; color: #000;">
                <ul class="nav" ui-nav>
                    <li class="nav-head">
                        <h5 class="nav-title text-uppercase light-txt">Sales Personnel</h5>
                    </li>
                    ...
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>customers.php"><i class="fa fa-circle-o"></i><span>Customers Management </span></a>
                    </li>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-sub">
                            ...
                            <li class="">
                                <a href="<?php echo $this->full_url; ?>pending_request.php"><i class="fa fa-circle-o"></i><span> Pending Requests </span></a>
                            </li>
                        </ul>
                    </li>
<!-- 
