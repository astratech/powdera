        ...
        <div id="ui" class="ui">
            ...
            <aside id="aside" class="ui-aside" style="background-color: #fafafa; color: #000;">
                <ul class="nav" ui-nav="">
                    ...
                    <li class="active">
                        <a><i class="fa fa-circle-o"></i><span>Production Batch</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="nav nav-sub">
                            <li class="">
                                <a href="<?php echo $this->full_url; ?>prod_batch_history.php"><i class="fa fa-circle"></i><span>History </span></a>
                            </li>
                            <li class="">
                                <a href="<?php echo $this->full_url; ?>create_prod_batch.php"><i class="fa fa-circle"></i><span>Create New </span></a>
                            </li>
                        </ul>
                    </li>
