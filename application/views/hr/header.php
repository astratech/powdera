    ...
    <body>
        ...
        <div id="ui" class="ui">
            ...
            <aside id="aside" class="ui-aside" style="background-color: #fafafa; color: #000;">
                <ul class="nav" ui-nav>
                    <li class="nav-head">
                        <h5 class="nav-title text-uppercase light-txt">Human Resource Manager</h5>
                    </li>
                    ...
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>leave_approval.php"><i class="fa fa-circle-o"></i><span>Leave Approvals </span></a>
                    </li>

                    <li class="active">
                        <a><i class="fa fa-circle-o"></i><span>Staff</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="nav nav-sub">
                            <li class="">
                                <a href="<?php echo $this->full_url; ?>approve_staff.php"><i class="fa fa-circle-o"></i><span> Approve Staff </span></a>
                            </li>
                            <li class="">
