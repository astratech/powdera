                <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        $(".delete").click(function(e){
                            ...
                            var ph = $(this).attr('ph');
                            var gh = $(this).attr('gh');
                            var c_url = "<?php echo $this->config->base_url().'admin/merge' ?>";
                            ...
                            if(con){
                                $.ajax({
                                    ...
                                    success: function (data, status) {
                                        ...
                                        result = result.trim();
                                        if (result == "1") {
                                            window.location.href = "<?php echo $this->config->base_url().'admin/merge' ?>";
                                        }
                                        else {
                                            alert('failed');
                                        }
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <select name="ph_id" style="width:100%;">
                                                            <option></option>
                                                            <?php
                                                                $q = $this->db->query("SELECT * FROM ph WHERE is_confirmed='0' AND hidden='0' AND merged_20='0' ORDER BY id ASC");
                    ...
                    <div class="content">
                        ...
                        <div class="block">
                            <div class="block-header">
                                <a href="<?php echo $this->config->base_url();?>admin/merge" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
                                    ...
                                    <table class="table table-striped table-vcenter table-bordered">
                                        ...
                                        <?php
                                            ...
                                            foreach ($list->result() as $r) {
                                                ...
                                                echo "<td>$r->id</td>";
                                                echo "<td>";
                                                if(is_null($this->admin_model->get_ph($r->ph_id)->username)){
                                                    echo "BLOCKED";
                                                }
                                                else{
                                                    echo $this->admin_model->get_ph($r->ph_id)->username;
                                                }
                                                echo "</td>";
