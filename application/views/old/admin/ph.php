                    ...
                    <div class="content">
                        ...
                        <div class="block">
                            <div class="block-header">
                                <a href="<?php echo $this->config->base_url();?>admin/ph" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
                                    ...
                                    <table class="table table-striped table-vcenter table-bordered">
                                        ...
                                        <?php
                                            ...
                                            foreach ($list->result() as $r) {
                                                ...
                                                // echo "<td>Day $day<br>$gp%<br>₦ $gmoney</td>";
