                                    ...
                                    <div class="block-content block-content-full">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <h1 class="h1 font-w300 text-white animated fadeInDown push-50-t push-5">GH Scale</h1>

                                            </div>

                                            <div class="col-sm-6">

                                                <button class="btn btn-primary pull-right push-50-t"5 href="#modal-merge" data-toggle="modal">Select GH</button>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-vcenter table-bordered">
                                        ...
                                        <?php
                                            ...
                                            echo "GH TRANSACTION NUMBER ".$this->admin_model->get_gh($gh_id)->trans_num."<br/>";
                                            ...
                                            if(empty($list_err)){
                                                ...
                                                $sn++;
                                                    ...
                                                    echo "<td>GH Amount = $gh_amount</td>";

                                                    echo "<td>Amount Merged = $total_merge</td>";

                                                    echo "<td>Merge Paid = $merge_paid</td>";

                                                    echo "<td>Amount Left to merge = ".($gh_amount - $total_merge)."</td>";
                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <select name="gh_trans_num" class="form-control">

                                                    <option></option>

                                                    <?php

                                                        $q = $this->db->query("SELECT * FROM gh ORDER BY id DESC");
