                <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        $(".delete").click(function(e){
                            e.preventDefault();
                            var id = $(this).attr('id');
                            var c_url = "<?php echo $this->config->base_url().'back/users' ?>";
                            ...
                            if(con){
                                $.ajax({
                                    ...
                                    success: function (data, status) {
                                        ...
                                        result = result.trim();
                                        if (result == "1") {
                                            window.location.href = "<?php echo $this->config->base_url().'back/users' ?>";
                                        }
                                        else {
                                            alert('failed');
                                        }
                    ...
                    <div class="content">
                        ...
                        <div class="block">
                            <div class="block-header">
                                <a href="<?php echo $this->config->base_url();?>back/users" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
