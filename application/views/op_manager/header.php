    ...
    <body>
        ...
        <div id="ui" class="ui">
            ...
            <aside id="aside" class="ui-aside" style="background-color: #fafafa; color: #000;">
                <ul class="nav" ui-nav="">
                    <li class="nav-head">
                        <h5 class="nav-title text-uppercase light-txt">Operation Manager</h5>
                    </li>
                    ...
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>process.php"><i class="fa fa-circle-o"></i><span>Process Management </span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>create_biz_line.php"><i class="fa fa-circle-o"></i><span>Create Line of Biz </span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>manage_biz_line.php"><i class="fa fa-circle-o"></i><span>Manage Line of Biz </span></a>
                    </li>
                    ...
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>profile.php"><i class="fa fa-user"></i><span>Profile </span>
                        </a>
                    </li>
                </ul>
                <div>
