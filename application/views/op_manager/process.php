                ...
                $(document).ready(function () {
                    ...
                    $(".shwAppModal").click(function (e) {
                        ...
                        try{
                            ...
                            $("#app-modal input[name='process_id']").val(d.id);
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body table-responsive">
                                        <p><button class="btn btn-primary c-n-q">Add new Process</button></p>
                                        ...
                                        <table class="table convert-data-table table-striped table-bordered">
                                            ...
                                            <tbody style="text-align: left; color: #000;">
                                                ...
                                                <?php
                                                    ...
                                                    $st = $this->db->query("SELECT * FROM process ORDER BY id DESC");
                ...
                <div class="modal-dialog" role="dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-primary" value="Submit" name="create_process" />
                        </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="modal-dialog" role="dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                            <input type="submit" class="btn btn-primary" value="Continue" name="delete_process" />
                        </div>
                        </form>
                    </div>
                </div>
