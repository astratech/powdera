        ...
        <div id="ui" class="ui">
            ...
            <aside id="aside" class="ui-aside" style="background-color: #fafafa; color: #000;">
                <ul class="nav" ui-nav>
                    ...
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>dashboard"><i class="fa fa-home"></i><span>Dashboard </span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>schedules"><i class="fa fa-calendar"></i><span>Schedules</span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>create_staff"><i class="fa fa-user-plus"></i><span>Create Staff </span></a>
                    </li>
                    ...
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>profile"><i class="fa fa-user"></i><span>Edit Profile </span></a>
                    </li>
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>payroll"><i class="fa fa-credit-card"></i><span>Payroll </span></a>
                    </li>
                </ul>
                <div>
