                ...
                $(document).ready(function () {
                    ...
                    $(".shwAppModal").click(function (e) {
                        ...
                        try{
                            ...
                            $("#app-modal input[name='schedule_id']").val(d.id);
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body table-responsive">
                                        <p><button class="btn btn-primary c-n-q">Add new Schedule</button></p>
                                        ...
                                        <table class="table convert-data-table table-striped table-bordered">
                                            ...
                                            <tbody style="text-align: left; color: #000;">
                                                ...
                                                <?php
                                                    ...
                                                    $st = $this->db->query("SELECT * FROM pa_schedule ORDER BY id DESC");
                                                    foreach ($st->result() as $r) {
                                                        ...
                                                        echo "<td>$r->reminder</td>";
               
                                                        echo "<td>".date("d-M-Y", strtotime($r->r_when))."</td>";
                        ...
                        <div class="modal-body">
                                <div class="row dform" style="padding: 20px;">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="reminder" required="required">
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12">
                                        <label>When</label>
                                        <input type="text" class="form-control" name="when" id="when" required="required" >
                                    </div>
                                </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                            <input type="submit" class="btn btn-primary" value="Submit" name="add_reminder" />
                        </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="modal-dialog" role="dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                            <input type="submit" class="btn btn-primary" value="Continue" name="delete_sch" />
                        </div>
                        </form>
                    </div>
                </div>
