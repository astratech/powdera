    ...
    <body>
        ...
        <div id="ui" class="ui">
            ...
            <aside id="aside" class="ui-aside" style="background-color: #fafafa; color: #000;">
                <ul class="nav" ui-nav>
                    <li class="nav-head">
                        <h5 class="nav-title text-uppercase light-txt">Store Keeper</h5>
                    </li>
                    ...
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>requests.php"><i class="fa fa-circle-o"></i><span>Pending Requests </span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>request_history.php"><i class="fa fa-circle-o"></i><span>Request History </span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>suppliers.php"><i class="fa fa-circle-o"></i><span>Suppliers Management </span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>materials.php"><i class="fa fa-circle-o"></i><span>Incoming Materials </span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>units.php"><i class="fa fa-circle-o"></i><span>Units </span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>writeoff.php"><i class="fa fa-circle-o"></i><span> Write Off</span></a>
                    </li>
