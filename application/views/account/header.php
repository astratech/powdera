    ...
    <body>
        ...
        <div id="ui" class="ui">
            ...
            <aside id="aside" class="ui-aside" style="background-color: #fafafa; color: #000;">
                <ul class="nav" ui-nav>
                    <li class="nav-head">
                        <h5 class="nav-title text-uppercase light-txt">Account Manager</h5>
                    </li>
                    ...
                    <li class="active">
                        <a><i class="fa fa-circle-o"></i><span>Payroll Management</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="nav nav-sub">
                            <li class="">
                                <a href="<?php echo $this->full_url; ?>salary.php"><i class="fa fa-circle-o"></i><span>Salary </span></a>
                            </li>
                            <li class="">
                                <a href="<?php echo $this->full_url; ?>allowance.php"><i class="fa fa-circle-o"></i><span>Special Allowances </span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-sub">
                            <li class="">
                                <a href="<?php echo $this->full_url; ?>vendors.php"><i class="fa fa-circle-o"></i><span>Manage Vendors </span></a>
                            </li>
                            <li class="">
                                <a href="<?php echo $this->full_url; ?>vendor_payment.php"><i class="fa fa-circle-o"></i><span>Vendors Payment </span></a>
                            </li>
                        </ul>
                    </li>
