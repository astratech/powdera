                ...
                $(document).ready(function () {
                    ...
                    $(".shwEditModal").click(function (e) {
                        ...
                        try{
                            ...
                            $("#edit-modal input[name='name']").val(d.name);
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body table-responsive">
                                        <p><button class="btn btn-primary c-n-q">Create New Category</button></p>
                                        ...
                                        <table class="table convert-data-table table-striped table-bordered">
                                            ...
                                            <tbody style="text-align: left; color: #000;">
                                                ...
                                                <?php
                                                    ...
                                                    $st = $this->db->query("SELECT * FROM exp_category ORDER BY id DESC");
