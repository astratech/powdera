        ...
        <div id="ui" class="ui">
            ...
            <aside id="aside" class="ui-aside" style="background-color: #fafafa; color: #000;">
                <ul class="nav" ui-nav>
                    ...
                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>requests.php"><i class="fa fa-circle-o"></i><span>Product Requests</span></a>
                    </li>

                    <li class="active">
                        <a href="<?php echo $this->full_url; ?>profile.php"><i class="fa fa-user"></i><span>Manage Profile </span></a>
                    </li>
                </ul>
                <div>
