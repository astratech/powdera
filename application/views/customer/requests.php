                        ...
                        <div class="modal-body">
                            <div class="row dform" style="padding: 20px;">
                                    <div class="form-group col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="sales_product_id" required="required" value="" readonly>
                                        <input type="text" class="form-control" name="price" value="" readonly>
                                    </div>

                                    <div class="form-group col-xs-12">
                                        <label>Quantity Available</label>
                                        <input type="number" class="form-control" name="quantity_available" required="required">
                                    </div>
