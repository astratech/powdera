                                                ...
                                                <?php
                                                    ...
                                                    foreach ($st->result() as $r) {
                                                        ...
                                                        if($r->warehouse_approved == 1){
                                                            ...
                                                            echo "<td>";
                                                            echo " <button class='btn btn-primary shwAppModal btn-sm' data-all='".json_encode($r)."'><i class='fa fa-tick'></i> Approve</button>";
                                                            echo " <button class='btn btn-danger shwDecModal btn-sm' data-all='".json_encode($r)."'><i class='fa fa-trash'></i> Delete</button>";
                                                            echo "</td>";
                                                        }
