                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <section class="panel">
                                        <header class="panel-heading panel-border">
                                          <p>Process 1 :: <?php echo $this->site_model->get_process($this->site_model->get_assigned_process($current_ass_process_id)->process_id)->name; ?> </p>
                                        <span class="tools pull-right">
                                            <a class="collapse-box fa fa-chevron-down" href="javascript:;"></a>
                                        </span>
                                        </header>
                                        <div class="panel-body">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="col-md-12" style="border: 1px solid #ccc;">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="num_of_input" id="boxNumOfInput" class="form-control" value="<?php echo $this->site_model->get_prod_batch_process($prod_batch_process_id)->num_of_input; ?>" readonly>
                                                            </div>
                                                ...
                                                <form class="pow" action="" method="POST">
                                                    <div class="col-md-3">
                                                        <div class="col-md-12" style="border: 1px solid #ccc;">
                                                            <div class="form-group">
                                                                <label>Number of Input Items</label>
                                                                <input type="number" name="num_of_input" class="form-control">
                                                            </div>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_SESSION['cache_form_prod_batch']['last_prod_batch_process_id'])){
                                                    if($this->site_model->get_prod_batch_process($_SESSION['cache_form_prod_batch']['last_prod_batch_process_id'])->status == "pending"){
                                                
                                            ?>
                                                <form class="pow form-horizontal" action="" method="POST">
                                                    <div class="col-md-12">
                                                        <div class="col-md-12" style="border: 1px solid #ccc; margin-top: 10px;">
                                                            <h5>Enter the Input items</h5>
                                                            <div class="col-md-12">
                                                                <div class="row dform ent-form" style="padding: 20px;">
                                                                    ...
                                                                    ?>
                                                                        <div class="form-group ent-inp">
                                                                            <div class="col-md-2">
                                                                                <label>S/N</label>
                                                                                <input class="form-control" type="text" name="sn[]" value="<?php echo $sn;?>" id="tempNumOfInput">
                                                                            </div>

                                                                            <div class="col-md-7">
                                                                               <label>Select Item</label>
                                                                               <select class="form-control s2" name="item_id[]">
                                                                               <?php
                                                                ...
                                                                <button class="btn btn-info addItem">Add One more Item</button>
                                                                <p></p>
                                                                
                                                                    <p>
                                                                        <input class="btn btn-primary form-control" type="submit" name="reg_items" value="Submit Items for Approval">
                                                                    </p>
                                                            </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                        ...
                                                                        $prod_batch_process_id = $_SESSION['cache_form_prod_batch']['last_prod_batch_process_id'];
                                                                        $sn = 1;
                                                                        $list = $this->db->query("SELECT * FROM prod_input_items WHERE prod_batch_id='$prod_batch_id' AND prod_batch_process_id='$prod_batch_process_id' ORDER BY id DESC");
                                                                        foreach ($list->result() as $rr) {

                                                                           echo "<tr>";
                                                                           echo "<td>$sn</td>";
                                                                           echo "<td>".$this->site_model->get_store_item($rr->store_item_id)->item_name."</td>";
                                                                           echo "<td>$rr->quantity</td>";
                                                                           echo "<td>".$this->site_model->get_store_item($rr->store_item_id)->unit."</td>";
                                                        ...
                                                        <div class="col-md-12" style="border: 1px solid #ccc; margin-top: 10px;">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <p></p>
                                                                    ...
                                                                    <p>
                                                                        <input class="btn btn-primary form-control" type="submit" name="reg_output_items" value="Go to Next Process">
                                                                    </p>
                                                            </div>
                                                        </div>
                                                    </div>
